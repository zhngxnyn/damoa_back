...
import com.second.damoa.social.security.oauth2.user.OAuth2UserInfo;
import com.second.damoa.social.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends CustomDefaultOAuth2UserService {
    ...
    private User registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
        ...
        user.setProfile(oAuth2UserInfo.getProfile());
        return userRepository.save(user);
    }

    private User updateExistingUser(User existingUser, OAuth2UserInfo oAuth2UserInfo) {
        existingUser.setName(oAuth2UserInfo.getName());
        existingUser.setProfile(oAuth2UserInfo.getProfile());
